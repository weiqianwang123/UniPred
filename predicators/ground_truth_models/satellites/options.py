...
class SatellitesGroundTruthOptionFactory(GroundTruthOptionFactory):
    """Ground-truth options for the satellites environment."""
    ...
    def get_options(cls, env_name: str, types: Dict[str, Type],
        ...
        UseCamera = utils.SingletonParameterizedOption(
            "UseCamera",
            types=[sat_type, obj_type],
            policy=cls._create_use_instrument_policy())

        UseInfraRed = utils.SingletonParameterizedOption(
            "UseInfraRed",
            types=[sat_type, obj_type],
            policy=cls._create_use_instrument_policy())
        ...
        return {MoveTo, MoveAway, Calibrate, ShootChemX, ShootChemY, UseCamera, UseInfraRed, UseGeiger}
