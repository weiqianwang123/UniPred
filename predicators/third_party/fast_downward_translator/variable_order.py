...
class VariableOrder:
    ...
    def _apply_to_mutexes(self, mutexes):
        ...
        logging.info("%s of %s mutex groups necessary." %
        ...
        for op in operators:
            ...
            if pre_post:
                ...
                op.prevail = [(self.new_var[var], val)
                              ...
                              if var in self.new_var]
                new_ops.append(op)
        logging.info("%s of %s operators necessary." % (len(new_ops), len(operators)))
        operators[:] = new_ops
    ...
    def _apply_to_axioms(self, axioms):
        ...
        logging.info("%s of %s axiom rules necessary." %
...
def find_and_apply_variable_order(sas_task,
    ...
    if reorder_vars or filter_unimportant_vars:
        ...
        if filter_unimportant_vars:
            ...
            logging.info("%s of %s variables necessary." %
