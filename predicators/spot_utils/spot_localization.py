...
class SpotLocalizer:
    ...
    def __init__(self, robot: Robot, upload_path: Path,
        ...
        self._hand_pose = math_helpers.SE3Pose(0, 0, 0, math_helpers.Quat())
    ...
    def get_last_hand_pose(self) -> math_helpers.SE3Pose:
        """Get the last estimated hand pose.
    ...
    def localize(self,
        ...
        robot_state = get_robot_state(self._robot)
        current_body2hand = get_a_tform_b(
            robot_state.kinematic_state.transforms_snapshot,
            "body", "hand"
        )
        self._hand_pose = self._robot_pose * current_body2hand
        return None
...
if __name__ == "__main__":
    ...
    from predicators.spot_utils.utils import get_graph_nav_dir, verify_estop, spot_stand
    ...
    def _run_manual_test() -> None:
        ...
        for _ in range(20):
            ...
            localizer_content['body'].append(robot_pose.to_matrix())
            localizer_content['hand'].append(hand_pose.to_matrix())
            print(f"Robot yaw: {robot_pose.rot.to_yaw()}")
        
        with open("localizer_on_ground_stowed.pkl", "wb") as f:
