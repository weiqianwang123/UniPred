...
do
    ...
    if python3 predicators/main.py --env blocks_engrave_pcdnorm --approach gnn_nsrt_policy \
        ...
        --approach_dir "saved_approaches/final/blocks_pcd/gnn_policy_$seed" \
        --log_file logs/final/blocks_pcd/sim/gnn_policy_ood_$seed.log; then
    ...
    if python3 predicators/main.py --env blocks_engrave_pcdnorm --approach gnn_nsrt_policy \
        ...
        --ivntr_nsrt_path "saved_approaches/blocks_engrave_pcdnorm/ivntr_${seed}/blocks_engrave_pcdnorm__ivntr__${seed}__On,OnTable,GripperOpen,Holding,Clear,Single,Matched,FaceUp,FaceDown___aesuperv_False__.saved" \
        --approach_dir "saved_approaches/final/blocks_pcd/gnn_policy_$seed" \
        --log_file logs/final/blocks_pcd/sim/gnn_policy_in_domain_$seed.log; then
        echo "Seed $seed completed successfully."
    else
        echo "Seed $seed encountered an error."
    fi
