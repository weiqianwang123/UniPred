...
do
    ...
    if python3 predicators/main.py --env pickplace_stair --approach ivntr \
        ...
        --neupi_gt_sampler True \
        --approach_dir "saved_approaches/final/pickplace_stair/ivntr_$seed" \
        --neupi_load_pretrained "saved_approaches/final/pickplace_stair/ivntr_$seed" \
        --log_file logs/final/pickplace_stair/sim/ivntr_search_no_quant_$seed.log; then
